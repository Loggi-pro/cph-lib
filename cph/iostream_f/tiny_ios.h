#pragma once
#include <cph/enum.h>
#include <cph/string.h> //char_traits.h


typedef size_t streamsize_t;
...
class basic_ios : public ios_base {
	public:
		typedef cph::char_traits<char_type> trates;
...
IO_DECLARE_STREAM_MANIPULATOR(bin, ios_base::bin, ios_base::basefield)
